        ...
        <ScrollView style={{flex: 1}}>
          ...
          <View style={{marginTop: '8%', marginLeft: '10%'}}>
            <Pressable
              ...
              <View style={{flexDirection: 'row'}}>
                <Image
                  source={require('../../Assets/Images/portfolioBlack.png')}
                  style={{
                    width: 18,
                    height: 18,
                    justifyContent: 'center',
                ...
                />
                <Heading
                  Heading={'Precious Metal Portfolio Tool'}
                  Fontsize={15}
                  color={COLORS.dark}
                  Fontweight={'bold'}
                  width={170}
          ...
          {/* <View style={{marginTop: '8%', marginLeft: '10%'}}>
            <Pressable
              ...
              <View style={{flexDirection: 'row'}}>
                <Image
                  source={require('../../Assets/Images/shopBlack.png')}
                  style={{
                    width: 18,
                    height: 18,
                    justifyContent: 'center',
            ...
            <Pressable
              onPress={() => {
                Navigation.navigate('AddMetal');
              }}>
              <View style={{flexDirection: 'row'}}>
                <Image
                  source={require('../../Assets/Images/AddMetal.png')}
                  style={{
                    width: 18,
                    height: 18,
                    justifyContent: 'center',
